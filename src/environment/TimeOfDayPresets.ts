...
export const TimeOfDayPresets: Record<string, TimeOfDayPreset> = {
  dawn: {
    ...
    hdrPath: 'assets/hdr/dawn_1k.exr'
  },
  day: {
    id: 'day',
    name: 'Day',
  ...
  dusk: {
    ...
    hdrPath: 'assets/hdr/dusk_1k.exr'
  },
  night: {
    id: 'night',
    name: 'Night',
    ...
    hdrPath: 'assets/hdr/night_1k.exr',
    hdrVerticalOffset: 0.15
  }
}
